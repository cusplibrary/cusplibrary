...
struct TestComplexStdComplexConversion
{
    void operator()(void)
    {
...

        {
            StdComplex a(0,0);
            CuspComplex b = a;
            ASSERT_EQUAL(b, CuspComplex(0,0));
        }
        {
            StdComplex a(0,1);
            CuspComplex b = a;
            ASSERT_EQUAL(b, CuspComplex(0,1));
        }
        {
            StdComplex a(1,0);
            CuspComplex b = a;
            ASSERT_EQUAL(b, CuspComplex(1,0));
        }
        {
            StdComplex a(1,2);
            CuspComplex b = a;
            ASSERT_EQUAL(b, CuspComplex(1,2));
        }

        {
            CuspComplex a(0,0);
            StdComplex b = a;
            ASSERT_EQUAL(b, StdComplex(0,0));
        }
        {
            CuspComplex a(0,1);
            StdComplex b = a;
            ASSERT_EQUAL(b, StdComplex(0,1));
        }
        {
            CuspComplex a(1,0);
            StdComplex b = a;
            ASSERT_EQUAL(b, StdComplex(1,0));
        }
        {
            CuspComplex a(1,2);
            StdComplex b = a;
            ASSERT_EQUAL(b, StdComplex(1,2));
        }
    }
};
