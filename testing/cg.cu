...
void TestConjugateGradient(void)
{
    ...
    cusp::read_matrix_market_file(A, "data/laplacian/5pt_10x10.mtx");
    //cusp::read_matrix_market_file(csr, "data/laplacian/7pt_10x10x10.mtx");
    //cusp::read_matrix_market_file(csr, "data/laplacian/3pt_100.mtx");
