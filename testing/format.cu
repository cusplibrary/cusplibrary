...
void TestMatrixFormatArray1d(void)
{
    ...
    ASSERT_EQUAL((bool) (std::is_same<format,cusp::array1d_format>::value), true);
    ASSERT_EQUAL((bool) (std::is_convertible<format,cusp::sparse_format>::value), false);
    ASSERT_EQUAL((bool) (std::is_convertible<format,cusp::dense_format>::value), true);
    ASSERT_EQUAL((bool) (std::is_convertible<format,cusp::known_format>::value), true);
}
...
void TestMatrixFormatArray2d(void)
{
    ...
    ASSERT_EQUAL((bool) (std::is_same<format,cusp::array2d_format>::value), true);
    ASSERT_EQUAL((bool) (std::is_convertible<format,cusp::sparse_format>::value),false);
    ASSERT_EQUAL((bool) (std::is_convertible<format,cusp::dense_format>::value), true);
    ASSERT_EQUAL((bool) (std::is_convertible<format,cusp::known_format>::value), true);
}
...
void TestMatrixFormatCooMatrix(void)
{
    ...
    ASSERT_EQUAL((bool) (std::is_same<format,cusp::coo_format>::value), true);
    ASSERT_EQUAL((bool) (std::is_convertible<format,cusp::sparse_format>::value), true);
    ASSERT_EQUAL((bool) (std::is_convertible<format,cusp::dense_format>::value), false);
    ASSERT_EQUAL((bool) (std::is_convertible<format,cusp::known_format>::value), true);
}
...
void TestMatrixFormatCsrMatrix(void)
{
    ...
    ASSERT_EQUAL((bool) (std::is_same<format,cusp::csr_format>::value), true);
    ASSERT_EQUAL((bool) (std::is_convertible<format,cusp::sparse_format>::value), true);
    ASSERT_EQUAL((bool) (std::is_convertible<format,cusp::dense_format>::value), false);
    ASSERT_EQUAL((bool) (std::is_convertible<format,cusp::known_format>::value), true);
}
...
void TestMatrixFormatDiaMatrix(void)
{
    ...
    ASSERT_EQUAL((bool) (std::is_same<format,cusp::dia_format>::value), true);
    ASSERT_EQUAL((bool) (std::is_convertible<format,cusp::sparse_format>::value), true);
    ASSERT_EQUAL((bool) (std::is_convertible<format,cusp::dense_format>::value), false);
    ASSERT_EQUAL((bool) (std::is_convertible<format,cusp::known_format>::value), true);
}
...
void TestMatrixFormatEllMatrix(void)
{
    ...
    ASSERT_EQUAL((bool) (std::is_same<format,cusp::ell_format>::value), true);
    ASSERT_EQUAL((bool) (std::is_convertible<format,cusp::sparse_format>::value), true);
    ASSERT_EQUAL((bool) (std::is_convertible<format,cusp::dense_format>::value), false);
    ASSERT_EQUAL((bool) (std::is_convertible<format,cusp::known_format>::value), true);
}
...
void TestMatrixFormatHybMatrix(void)
{
    ...
    ASSERT_EQUAL((bool) (std::is_same<format,cusp::hyb_format>::value), true);
    ASSERT_EQUAL((bool) (std::is_convertible<format,cusp::sparse_format>::value), true);
    ASSERT_EQUAL((bool) (std::is_convertible<format,cusp::dense_format>::value), false);
    ASSERT_EQUAL((bool) (std::is_convertible<format,cusp::known_format>::value), true);
}
