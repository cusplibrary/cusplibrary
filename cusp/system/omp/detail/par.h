...
struct par_t : public cusp::system::omp::detail::execution_policy<par_t>
{
  public:
  par_t() : cusp::system::omp::detail::execution_policy<par_t>() {}

  template<typename Allocator>
    thrust::detail::execute_with_allocator<Allocator, cusp::system::omp::detail::execution_policy>
      operator()(Allocator &alloc) const
  {
    return thrust::detail::execute_with_allocator<Allocator, cusp::system::omp::detail::execution_policy>(alloc);
  }
};
