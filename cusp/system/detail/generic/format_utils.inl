                      ...
                      cusp::csr_format)
{
    ...
    thrust::scatter_if(exec,
                       ...
                       thrust::make_transform_iterator(
                           thrust::make_zip_iterator(
                               ::cuda::std::make_tuple(row_indices.begin(), A.column_indices.begin())),
                           cusp::equal_pair_functor<IndexType>()),
                       output.begin());
}
                        ...
                        const OffsetArray& offsets, IndexArray& indices)
{
    ...
    thrust::scatter_if( exec,
                        ...
                        offsets.begin(),
                        thrust::make_transform_iterator(
                            thrust::make_zip_iterator( ::cuda::std::make_tuple( offsets.begin(), offsets.begin() + 1 ) ),
                       ...
                       const ArrayType2& column_indices )
{
    ...
    thrust::scatter(exec,
                    ...
                    thrust::make_transform_iterator(
                        thrust::make_zip_iterator(
                            ::cuda::std::make_tuple( row_indices.begin(), column_indices.begin() ) ),
