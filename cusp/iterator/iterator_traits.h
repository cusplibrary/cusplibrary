...
struct iterator_system
        ...
        : thrust::detail::eval_if<
          std::disjunction<
            std::is_same<Space, thrust::host_system_tag>,
            std::is_same<Space, cusp::host_memory>
        >::value,
        ...
        thrust::detail::eval_if<
          std::disjunction<
            std::is_same<Space, thrust::device_system_tag>,
            std::is_same<Space, cusp::device_memory>
        >::value,
        ...
        thrust::detail::eval_if<
          std::disjunction<
            std::is_same<Space, thrust::any_system_tag>,
            std::is_same<Space, cusp::any_memory>
        >::value,
