...
// forward declaration of random_iterator
template<typename,typename,typename> class random_iterator;
  ...
  struct random_iterator_base
{
  ...
  typedef typename thrust::iterator_adaptor<
    random_iterator<Value, Incrementable, System>,
    base_iterator,
