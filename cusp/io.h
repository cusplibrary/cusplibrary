...
template <typename IndexType, typename ValueType>
void load_matrix_market_file(cusp::csr_matrix<IndexType,ValueType,cusp::host>& csr, const std::string& filename)
{
    cusp::coo_matrix<IndexType,ValueType,cusp::host> coo;
    cusp::load_matrix_market_file(coo, filename);
    cusp::convert(csr, coo);
}
...
template <typename IndexType, typename ValueType>
void load_matrix_market_file(cusp::coo_matrix<IndexType,ValueType,cusp::device>& coo, const std::string& filename)
{
    // load on host
    cusp::coo_matrix<IndexType,ValueType,cusp::host> host_coo;
...
template <typename IndexType, typename ValueType>
void load_matrix_market_file(cusp::csr_matrix<IndexType,ValueType,cusp::device>& csr, const std::string& filename)
{
    // load on host
    cusp::csr_matrix<IndexType,ValueType,cusp::host> host_csr;
