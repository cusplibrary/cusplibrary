...
struct host_blas_policy
        : cusp::blas::__CUSP_HOST_BLAS_NAMESPACE::blas_policy<DerivedPolicy>
    {};

template<typename DerivedPolicy>
struct device_blas_policy
        : cusp::blas::__CUSP_DEVICE_BLAS_NAMESPACE::blas_policy<DerivedPolicy>
    {};
