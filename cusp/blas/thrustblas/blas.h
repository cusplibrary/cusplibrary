...
void axpy(ForwardIterator1 first1,
          ...
          ScalarType alpha)
{
  cusp::blas::thrustblas::detail::axpy(first1, last1, first2, alpha);
}
...
void axpby(InputIterator1 first1,
           ...
           ScalarType beta)
{
  cusp::blas::thrustblas::detail::axpby(first1, last1, first2, output, alpha, beta);
}
...
{
    CUSP_PROFILE_SCOPED();
    cusp::blas::thrustblas::detail::axpbypcz(first1, last1, first2, first3, output.begin(), alpha, beta, gamma);
}
